...
namespace Job_Entity.Controllers
{
    public class ProfessionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDProfession,Libbele_Proffession,Spesialite")] Profession profession)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDProfession,Libbele_Proffession,Spesialite")] Profession profession)
        {
            if (ModelState.IsValid)
            {
